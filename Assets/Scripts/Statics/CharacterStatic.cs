...
public static class CharacterStatic
{
    public static string name = "";
    public static string charDescription = "";
    public static List<string> statsLable = new List<string>();
    public static List<List<int>> statsValue = new List<List<int>>();
    public static List<string> skillLable = new List<string>();
    public static List<string> skillDescription = new List<string>();
